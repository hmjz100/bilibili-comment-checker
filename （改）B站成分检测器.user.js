...
(function BiliChecker() {
	...
	const checkers = [
		...
		},
		{
			...
			// [禁止骂我！禁止拉黑！.jpg]
			keywords: ["作死拿班", "易语言", "编程猫", "scratch", "ramos", "winpe", "bsod", "memz", "MEMZ", "XP Horror", "XPHorror", "xp horror", "xphorror", "WindowsCE", "下崽器", "aero", "setup", "DWM", "CmzPrep", "VMWare", "希沃白板", "Ubuntu PE", "PowerShell", "gnu/linux"],
			followings: [
				417138, // 你的两位朋友
				1585476, // 23胡彬MEMZ
				3299305, // qaqz111
