...
(function BiliChecker() {
	...
	const checkers = [
		...
		},
		{
			...
			// 正所谓：物以类聚，人以群分
			keywords: ["作死拿班", "整蛊老师", "易语言", "编程猫", "scratch", "ramos", "winpe", "bsod", "memz", "MEMZ", "XP Horror", "XPHorror", "xp horror", "xphorror", "WindowsCE", "下崽器", "aero", "setup", "DWM", "CmzPrep", "VMWare", "希沃白板", "Ubuntu PE", "PowerShell", "gnu/linux", "SYSTEM", "vista", "VISTA", "电脑病毒", "Windows卸载", "Trustedlnstaller"],
			followings: [
				417138, // 你的两位朋友
				1585476, // 23胡彬MEMZ
				3299305, // qaqz111
